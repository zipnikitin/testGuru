...
questions = Question.create!([{ title: 'Left Hand Riffing', test_id: tests[0].id },
                              { title: 'Legato', test_id: tests[1].id },
                              { title: 'Frantic Disembowelment', test_id: tests[2].id }])
answers = Answer.create!([{ title: '035065', question_id: questions[0].id, correct: true },
                          { title: '04070407', question_id: questions[1].id, correct: true },
                          { title: 'Eviscerate', question_id: questions[2].id, correct: true }])